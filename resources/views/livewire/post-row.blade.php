        ...
        <x-menu>
            ...
            <x-menu.items>
                <x-dialog wire:model="showEditDialog">
                    ...
                    <x-dialog.panel>
                        <form wire:submit="save" class="flex flex-col gap-4 text-gray">
                ...
                <x-dialog>
                    ...
                    <x-dialog.panel>
                        <div class="flex flex-col gap-6" x-data="{ confirmation: '' }">
                            ...
                            <h2 class="text-lg text-slate-700 text-gray-800">This operation is permanant and can be reversed. This post will be deleted forever.</h2>
